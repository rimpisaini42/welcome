...
<Card className={classes.root} key={turtle.name + index}>
<CardHeader
  avatar={
    <Avatar aria-label="recipe" className={classes.avatar} alt={`${turtle.name}`} src={turtle.imgUrl} />
  }
  action={
